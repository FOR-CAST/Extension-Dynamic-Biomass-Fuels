...
#define ExtensionName "Dynamic Biomass Fuels"
...
Source: {#BuildDir}\Landis.Extension.BiomassFuels-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Dynamic Biomass Fuels 3.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Dynamic Biomass Fuels"" "; WorkingDir: {#LandisPlugInDir}
